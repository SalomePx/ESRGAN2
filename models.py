...
class UpsampleBlock(nn.Module):
    def __init__(self, in_c, scale_factor=1):
        super().__init__()
...
class Generator(nn.Module):
    def __init__(self, in_channels=1, num_channels=64, num_blocks=23):
        super().__init__()
...
def DiscriminatorVGG128(size, channels, nf=64, wd=0., name='Discriminator_VGG_128'):
